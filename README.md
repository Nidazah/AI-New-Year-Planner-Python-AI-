...
- **Category-Specific Strategies**: 
  - **Study Mode**: Pomodoro Technique for focused learning
  - **Work Mode**: Time Blocking for productivity optimization
- **Adaptive Recommendations**: AI-powered advice based on your available hours:
  - < 2 hours/day: Micro-task approach (25-min sessions)
  - 2-4 hours/day: Deep focus blocks (90-min sessions)
...
```bash
git clone https://github.com/Nidazah/AI-New-Year-Planner-Python-AI-.git
cd AI-New-Year-Planner-Python-AI-
```
...
2. Applies productivity principles (Pomodoro, Time Blocking)
